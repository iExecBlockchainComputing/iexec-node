...
Start XtremWeb Worker In Docker
    ...
    Remove File  ${DIST_XWHEP_PATH}/xwhep.worker.process.log
    ${xtremweb_version} =  XWCommonDocker.Get Xtremweb Version  ${DIST_XWHEP_PATH}
    ...
    ${container_id} =  Wait Until Keyword Succeeds  30 min   10 sec  DockerHelper.Get Docker Container Id From Image  xtremweb/worker:${xtremweb_version}
    Log  ${container_id}
