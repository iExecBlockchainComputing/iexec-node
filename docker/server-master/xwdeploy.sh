...
docker cp ${CONTAINERNAME_SERVER}:/root/xtremweb-hep-master/build/dist/xwhep-10.6.0/xwhep-worker-10.6.0.deb ${ROOTDIR}
docker cp ${CONTAINERNAME_SERVER}:/root/xtremweb-hep-master/build/dist/xwhep-10.6.0/xwhep-client-10.6.0.deb ${ROOTDIR}
